...
class comptemedecin extends StatefulWidget {
  const comptemedecin({super.key});

  @override
  State<comptemedecin> createState() => _comptepatientState();
}

class _comptepatientState extends State<comptemedecin> {
                          ...
                          MaterialButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => formulairemedecin(),
                                ),
                              );
                            },
                            child: Text(
